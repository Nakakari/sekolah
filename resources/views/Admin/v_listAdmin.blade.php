                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-primary">Tambah Admin</h5>
                            </div>
                            <hr>
                            <form class="row g-3" action="/upload/admin" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="col-md-6">
                    ...
                    <div class="modal-body">
                        <div class="card border-top border-0 border-4 border-primary">
                            <div class="card-body p-5">
                                ...
                                <hr>
                                <form class="row g-3" action="/update/admin/{{ $all->id }}" method="POST"

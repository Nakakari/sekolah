...
<body class="antialiased">
    <div
        ...
        {{-- <a href="/siswa" class="button button1">Siswa</a> --}}
        @if (Route::has('login'))
            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">

                @auth
                    <a href="{{ url('/home') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Home</a>
                    {{-- <a href="/home" class="button button1">Siswa</a> --}}
                @else
                    <a href="{{ url('/siswa') }}" class="button button1">Siswa</a>
                    <a href="{{ route('login') }}" class="button button2">Guru</a>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="/siswa"
